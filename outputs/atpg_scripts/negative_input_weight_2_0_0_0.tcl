...
add_pi_constraints 0 op_a_i[6]
add_pi_constraints 0 op_a_i[5]
add_pi_constraints 0 op_a_i[4]
add_pi_constraints 1 op_a_i[3]
add_pi_constraints 1 op_a_i[2]
add_pi_constraints 0 op_a_i[1]
add_pi_constraints 0 op_a_i[0]
