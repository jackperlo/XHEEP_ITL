...
def generate_pattern_filled_input_image(model_name):
  ...
  with open(patterns_file_name, "r") as patterns_file:
    ...
    last_pattern_multiplied_index = "1,29,27,0"
    for x in range(32):
      for y in range(32):
        ...
        if suitable_pattern_index in input_image_options: 
          ...
          float32_value = np.float32((np.int8(int(input_image_options[last_pattern_multiplied_index][0], 16)) - lenet5_in_zero_point) * lenet5_in_scale)
